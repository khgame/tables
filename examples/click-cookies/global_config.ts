...
type GlobalConfigTID = string & { readonly __GlobalConfigTID: unique symbol };
const toGlobalConfigTID = (value: string): GlobalConfigTID => value as GlobalConfigTID;
...
export const globalConfig: Record<GlobalConfigTID, IGlobalConfig> = Object.fromEntries(
