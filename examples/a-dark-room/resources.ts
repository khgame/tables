...
type ResourcesTID = string & { readonly __ResourcesTID: unique symbol };
const toResourcesTID = (value: string): ResourcesTID => value as ResourcesTID;
...
export const resources: Record<ResourcesTID, IResources> = Object.fromEntries(
