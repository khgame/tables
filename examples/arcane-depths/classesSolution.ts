...
import { IClasses, ClassesTID, toClassesTID, ClassesRepo } from "./classes";
...
export const classesRaw = raw;
export const classesTids: ClassesTID[] = raw.tids.map(toClassesTID);
export const classesRecords: Record<ClassesTID, IClasses> = Object.fromEntries(
  Object.entries(raw.result).map(([tid, value]) => [toClassesTID(tid), value as IClasses])
);
export const classes = classesRecords;
export const classesRepo = ClassesRepo.fromRaw(raw);
