...
type ArtifactsTID = string & { readonly __ArtifactsTID: unique symbol };
const toArtifactsTID = (value: string): ArtifactsTID => value as ArtifactsTID;
...
export const artifacts: Record<ArtifactsTID, IArtifacts> = Object.fromEntries(
