...
import { IFacilities, FacilitiesTID, toFacilitiesTID, FacilitiesRepo } from "./facilities";
...
export const facilitiesRaw = raw;
export const facilitiesTids: FacilitiesTID[] = raw.tids.map(toFacilitiesTID);
export const facilitiesRecords: Record<FacilitiesTID, IFacilities> = Object.fromEntries(
  Object.entries(raw.result).map(([tid, value]) => [toFacilitiesTID(tid), value as IFacilities])
);
export const facilities = facilitiesRecords;
export const facilitiesRepo = FacilitiesRepo.fromRaw(raw);
