...
type SynergyCardsTID = string & { readonly __SynergyCardsTID: unique symbol };
const toSynergyCardsTID = (value: string): SynergyCardsTID => value as SynergyCardsTID;
...
export const synergyCards: Record<SynergyCardsTID, ISynergyCards> = Object.fromEntries(
