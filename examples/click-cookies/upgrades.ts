...
type UpgradesTID = string & { readonly __UpgradesTID: unique symbol };
const toUpgradesTID = (value: string): UpgradesTID => value as UpgradesTID;
...
export const upgrades: Record<UpgradesTID, IUpgrades> = Object.fromEntries(
