...
type JobsTID = string & { readonly __JobsTID: unique symbol };
const toJobsTID = (value: string): JobsTID => value as JobsTID;
...
export const jobs: Record<JobsTID, IJobs> = Object.fromEntries(
