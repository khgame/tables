...
type TasksTID = string & { readonly __TasksTID: unique symbol };
const toTasksTID = (value: string): TasksTID => value as TasksTID;
...
export const tasks: Record<TasksTID, ITasks> = Object.fromEntries(
