...
type SkillTreeTID = string & { readonly __SkillTreeTID: unique symbol };
const toSkillTreeTID = (value: string): SkillTreeTID => value as SkillTreeTID;
...
export const skillTree: Record<SkillTreeTID, ISkillTree> = Object.fromEntries(
