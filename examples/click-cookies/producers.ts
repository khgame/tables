...
type ProducersTID = string & { readonly __ProducersTID: unique symbol };
const toProducersTID = (value: string): ProducersTID => value as ProducersTID;
...
export const producers: Record<ProducersTID, IProducers> = Object.fromEntries(
