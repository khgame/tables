...
writeSheet('rooms.xlsx', [
  ...
  ['50', '04', '01', '00', 1, 'Elite', '熔核军械库', 10010100, '对抗熔核巨灵与其护卫。', 40010200, undefined, 'Relic', '60010000', '精英常驻熔火护盾，每回合爆发灼烧波'],
  ['50', '06', '02', '00', 2, 'Boss', '灰烬之主燃殿', 10010100, '灰烬之主统御火种，终焉决战即将开启。', 40010300, undefined, 'Relic', '60010000', 'Boss首次登场时施加全场灼烧'],
  ['50', '01', '02', '00', 2, 'Combat', '蔓生之巢', 10020100, '藤蔓潮汐的核心据点。', 40020300, undefined, 'Resource', 'Provision:18', '初始时所有敌人持有藤蔓护盾'],
  ['50', '02', '02', '00', 2, 'Event', '深根共鸣', 10020100, '旅者请求帮助，分享绿色共鸣。', undefined, 51020000, 'Resource', 'Provision:15', '成功则提升当前层的治愈效率'],
  ['50', '05', '01', '00', 1, 'Rest', '翠息静室', 10020100, '通过深绿脉络恢复与净化。', undefined, undefined, 'Trait', 'Synergy', '移除任意一个减益'],
  ['50', '06', '03', '00', 3, 'Boss', '藤界之心', 10020100, '削弱深根巨树的束缚并阻止其觉醒。', 40020300, undefined, 'Relic', '60020000', 'Boss召唤孢子爪牙并周期性缠绕全队'],
  ['50', '01', '03', '00', 3, 'Combat', '星火熔层', 10030100, '熔炉中游走的星火构装体。', 40030100, undefined, 'Resource', 'Arcane:16', '地图施加减速并周期性落下星火'],
  ['50', '04', '02', '00', 2, 'Elite', '星界锻卫', 10030100, '星界傀儡组成的防线。', 40030100, undefined, 'Relic', '60030000', '精英拥有反射护盾与星能回复'],
