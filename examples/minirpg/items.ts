...
type ItemsTID = string & { readonly __ItemsTID: unique symbol };
const toItemsTID = (value: string): ItemsTID => value as ItemsTID;
...
export const items: Record<ItemsTID, IItems> = Object.fromEntries(
